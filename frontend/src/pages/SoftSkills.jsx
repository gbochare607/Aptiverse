...
const skills = [
    {
        ...
        description: 'Verbal, non-verbal & written excellence',
    ...
    },
    {
        ...
        description: 'Tackle behavioral & situational questions',
        icon: UserGroupIcon,
        color: 'bg-blue-500',
    ...
    },
    {
        ...
        description: 'Master the art of effective debating',
    ...
    },
    {
        ...
        description: 'Driving results through collaboration',
        icon: SparklesIcon,
        color: 'bg-purple-500',
    ...
    },
    {
        ...
        description: 'Analytical reasoning & decision making',
    ...
    },
    {
        ...
        description: 'Productivity & priority frameworks',
        icon: ClockIcon,
        color: 'bg-cyan-500',
    ...
    },
    {
        ...
        description: 'Self-awareness and empathy at work',
...
export default function SoftSkills() {
    ...
    const startSkillSession = async (skillId) => {
        setLoading(true);
        try {
            ...
            const config = {
                ...
                duration: 0,
                difficulty: 0.5,
                topic: skillId, // Use skillId as topic
            ...
            console.error("Error starting soft skill session:", err);
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-black dark:font-bold text-slate-900 dark:text-white tracking-tight">Soft Skills Mastery</h1>
                            <p className="text-slate-600 dark:text-slate-400 mt-1 font-medium">Master Communication, Critical Thinking, and Interview Prep</p>
                        </div>
                    </div>
                    ...
                    <div className="relative w-full md:w-96 group">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <MagnifyingGlassIcon className="h-5 w-5 text-slate-400 group-focus-within:text-orange-500 transition-colors" />
                        </div>
                        <input
                            type="text"
                            placeholder="Search skills (Leadership, IQ...)"
                            value={searchQuery}
                            onChange={(e) => setSearchQuery(e.target.value)}
                            className="block w-full pl-10 pr-3 py-2.5 border border-slate-200 dark:border-white/10 rounded-xl leading-5 bg-white/50 dark:bg-white/5 text-slate-900 dark:text-slate-300 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:bg-white dark:focus:bg-white/10 focus:border-orange-500/50 dark:focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/50 sm:text-sm transition-all shadow-sm dark:shadow-lg"
                        />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredSkills.map((skill) => (
                        <div key={skill.id} className="group relative">
                            ...
                            <div className={`absolute -inset-0.5 rounded-[2rem] bg-gradient-to-r ${skill.gradient} opacity-0 group-hover:opacity-100 blur transition duration-500`} />

                            <button
                                onClick={() => startSkillSession(skill.id)}
                                disabled={loading}
                            ...
                            >
                                <div className="flex items-start justify-between mb-6">
                                    <div className={`p-4 rounded-2xl ${skill.color}/10 border ${skill.borderColor} ${skill.textColor}`}>
                                ...
                                <div className="mt-auto">
                                    <h3 className="text-xl font-bold dark:font-semibold text-slate-900 dark:text-white mb-1">{skill.name}</h3>
                                    <p className="text-sm text-slate-900 dark:text-slate-400 font-medium">{skill.description}</p>
                                </div>
                                ...
                                <div className="mt-6 pt-4 border-t border-slate-100 dark:border-white/5 flex items-center justify-between text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                                    ...
                                    <span className={`${skill.textColor} font-black`}>Start Test</span>
                                </div>
                            </button>
                        </div>
                    ))}
                ...
                {loading && (
                    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-white font-medium">Starting soft skills session...</p>
                        </div>
                    </div>
                )}
            </div>
