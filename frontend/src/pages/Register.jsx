    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-900">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute top-10 left-10 w-96 h-96 bg-indigo-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
            ...
            {/* Login Card */}
            <div className="relative z-10 w-full max-w-md mx-4 mt-8 mb-8">
